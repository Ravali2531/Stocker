...
// //       context,
// //       MaterialPageRoute(
// //         builder: (context) => StockDetailPage(stockSymbol: stock.symbol),
// //       ),
// //     );
// //   }
// //
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> fetchStockData() async {
    const String apiKey = 'S4ts5DZG3QleS272pmnx1fQKJ8mVZvYn';
            ...
            child: filteredStocks.isEmpty
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    title: Text(stock.symbol, style: const TextStyle(fontSize: 18)),
                    ...
                    trailing: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${stock.changePercentage.toStringAsFixed(2)}%',
                          style: TextStyle(color: stock.changePercentage >= 0 ? Colors.green : Colors.red),
                        ),
                      ],
                    ),
                    onTap: () => showStockDetails(stock),
